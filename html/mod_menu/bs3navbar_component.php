...
if ($item->deeper) {
	...
	//$flink = '#';
	$deeper = '<span class="caret"></span>';
}
$icon = '';
//if(preg_match('/^fa/', $item->anchor_css)){$icon = '<i class="'.$item->anchor_css.'"></i>';}

switch ($item->browserNav)
{
	default:
	case 0:
?><a <?php echo $class; ?>href="<?php echo $flink; ?>" <?php echo $title; ?>><?php echo $icon; ?><?php echo $linktype.' '.$deeper; ?></a><?php
		break;
	case 1:
		// _blank
?><a <?php echo $class; ?>href="<?php echo $flink; ?>" target="_blank" <?php echo $title; ?>><?php echo $linktype.' '.$deeper; ?></a><?php
		break;
	case 2:
	// window.open
